...
(function () {
  ...
  var MANIFEST = {
    playerDRDD:              { file: 'drdd.glb',          height: 3.5, swap:false, load:true, why:'auto-swap off — the player rig system adopts this model itself (adoptPlayerGLB in the game) and drives its animation clips' },
    characterDRDDFrogTop:    { file: 'drdd_frog.glb',     height: 3.0 },
    characterDipeGenie:      { file: 'genie.glb',         height: 1.1 },

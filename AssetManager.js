...
(function () {
  ...
  var MANIFEST = {
    ...
    enemyStooge_Larry:       { file: 'stooge_larry.glb',  height: 1.7, swap:false, why:'walk cycle needs userData.legPivots' },
    enemyStooge_Curly:       { file: 'stooge_curly.glb',  height: 1.7, swap:false, why:'walk cycle needs userData.legPivots' },
    enemyDuragStooge:        { file: 'stooge_durag.glb',  height: 1.7 },
    enemyOztrich:            { file: 'oztrich.glb',       height: 2.7 },
    enemyOztrichChase:       { file: 'oztrich_chase.glb', height: 2.6 },
    enemyPidgin:             { file: 'pidgin.glb',        height: 1.8 },
    enemyPidginChase:        { file: 'pidgin_chase.glb',  height: 1.9 },
    enemySeagle:             { file: 'seagle.glb',        height: 1.7 },
    enemySeagleChase:        { file: 'seagle_chase.glb',  height: 1.7 },
    enemyRoadstumbler:       { file: 'roadstumbler.glb',  height: 3.0 },
    enemyRoadstumblerBoss:   { file: 'roadstumbler.glb',  height: 3.2 },
    ...
    enemyMotoStooge:         { file: 'moto_stooge.glb',   height: 1.9, swap:false, why:'wheel spin rotates children[2]/[3]' },
    enemyFatStooge:          { file: 'fat_stooge.glb',    height: 2.2, swap:false, why:'HP gems found via getObjectByName hpgem0/1' },
    enemyDodoBird:           { file: 'dodo.glb',          height: 2.5, swap:false, why:'squash anim needs userData.bodyMesh' },
    enemyJoeLBossHead:       { file: 'joel_head.glb',     height: 4.6 }
  };
  var PATH = 'assets/';
